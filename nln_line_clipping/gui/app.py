...
class App:
    def __init__(self, root, nln_algorithm):
        self.root = root
        self.root.title("Line Clipping with NLN Algorithm")

        self.nln_algorithm = nln_algorithm
        ...
        nln_btn = ttk.Button(self.frame, text="NLN Algorithm",
                             command=self.on_algorithm_selected)
        nln_btn.grid(row=0, column=0, padx=5, pady=5, sticky="ew")
    ...
    def clip_line(self):
        ...
        clipped_line, logs = self.nln_algorithm(
